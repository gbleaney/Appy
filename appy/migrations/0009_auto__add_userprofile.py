...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'appy_userprofile', (
            ...
            ('email', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=50)),
        ))
    ...
    models = {
        ...
        u'appy.userprofile': {
            ...
            'email': ('django.db.models.fields.CharField', [], {'default': "''", 'unique': 'True', 'max_length': '50'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
