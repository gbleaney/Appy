...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'appy_userprofile')

        # Adding model 'Profile'
        db.create_table(u'appy_profile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='userprofile', unique=True, null=True, to=orm['auth.User'])),
        ))
        db.send_create_signal(u'appy', ['Profile'])


    def backwards(self, orm):
        # Adding model 'UserProfile'
        db.create_table(u'appy_userprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='userprofile', unique=True, null=True, to=orm['auth.User'])),
        ))
        db.send_create_signal(u'appy', ['UserProfile'])

        # Deleting model 'Profile'
        db.delete_table(u'appy_profile')
    ...
    models = {
        ...
        u'appy.appydevice': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inputs': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['appy.Input']", 'null': 'True', 'blank': 'True'}),
            'outputs': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['appy.Output']", 'null': 'True', 'blank': 'True'})
        },
        u'appy.basedevice': {
        ...
        u'appy.profile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'userprofile'", 'unique': 'True', 'null': 'True', 'to': u"orm['auth.User']"})
        },
        u'auth.group': {
